...
public abstract class NormalDecoration extends RecyclerView.ItemDecoration {
    ...
    private int headerHeight = 136;//头部高度
    ...
    public NormalDecoration(int width) {
        W = width;
...
//            });
        ...
        int right = W;//recyclerView.getRight() - recyclerView.getPaddingRight();
...
//           canvas.drawLine(0, headerHeight / 2, right, headerHeight / 2, mHeaderTxtPaint);//画条线看看文字居中不
    ...
    void setOnHeaderClickListener(OnHeaderClickListener headerClickListener) {
     ...
     */
    void setOnDecorationHeadDraw(OnDecorationHeadDraw decorationHeadDraw) {
